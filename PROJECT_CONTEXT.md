...
**Status:** Day 6 (Stage 2.2 shipped — printable Doctor Summary page/export consuming the Stage 2.1 backend contract; Stage 1.2 longitudinal insights + flagship dashboard card done; Repository views (Stage 2.3) next)
...
- **Unit tests:** **180/180 passing** (`npm test`)
