...
- **2026-06-10:** Vercel 250MB fix — removed `api/.deps/` full-package staging; `includeFiles` array targets only missing assets (~8MB OCR/PDF + native binaries) instead of duplicating entire `pdf-parse`/`tesseract.js-core`.
